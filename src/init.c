...
SEXP RAdbcConnectionNew(SEXP connection_xptr, SEXP error_xptr);
...
SEXP RAdbcConnectionGetInfo(SEXP connection_xptr, uint32_t* info_codes, size_t info_codes_length, SEXP out_stream_xptr, SEXP error_xptr);
...
SEXP RAdbcConnectionGetTableSchema(SEXP connection_xptr, SEXP catalog, SEXP db_schema, SEXP table_name, SEXP schema_xptr, SEXP error_xptr);
